  ...
  return (
    <div className="space-y-8 max-w-xl">
      <div>
        ...
        <p className="text-zinc-500 mt-1">Débloquez toutes les fonctionnalités</p>
      </div>

      <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8 text-center">
        <p className="text-zinc-400 mb-6">
          Avec le plan Premium, ajoutez autant de motos que vous voulez et profitez de
          toutes les fonctionnalités sans limite.
        </p>
        <p className="text-moto-orange text-sm">
          Bientôt disponible. Revenez plus tard pour passer en premium.
        </p>
        <Link
          href="/motorcycles"
